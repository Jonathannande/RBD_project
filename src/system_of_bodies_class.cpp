...
//the generic body type which the system boides stores, this class holds the traits which all bodies share - mass, a hinge-type, hinge position from center of mass, RBT
/*
class Body {
public:
...
public:
	...
	double b;
	double h;
	arma::vec transform_vector = {0,0,0,l,0,0}; //this is your transform vector - describes the transfer the next hinge, the curre
...
public:
	...
	double t {10.0};	//time at end of simulation
